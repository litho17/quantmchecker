...
public class DataServiceImpl implements org.jrecruiter.service.DataService {
	...
	public Image getGoogleMapImage(final BigDecimal latitude,
		...
		try {
			...
			@Bound("1") int i;
			@Inv("= renderingHints c89") final Map<Object, Object> renderingHints = CollectionUtils.getHashMap();
			c89: renderingHints.put(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
