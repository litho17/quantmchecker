...
public class BaseFormController implements ServletContextAware {
	...
	public void saveError(HttpServletRequest request, String error) {
		@InvUnk("Unknown API") List errors = (List) request.getSession().getAttribute(ERRORS_MESSAGES_KEY);
		if (errors == null) {
	...
	public void saveMessage(HttpServletRequest request, String msg) {
		@InvUnk("Unknown API") List messages = (List) request.getSession().getAttribute(MESSAGES_KEY);
