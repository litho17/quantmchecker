...
public class MigrationServiceImpl implements MigrationService {
	...
	public void migrateUserData(final Boolean digestPasswords) {
		...
		@InvUnk("Unknown API") final List<User> users = this.jdbcTemplateV1.query(sql, mapper);
	...
	public void migrateJobData() {
		...
		@InvUnk("Unknown API") final List<Job> jobs = this.jdbcTemplateV1.query(sql, mapper);
