...
*/
package SnapBuddy_1.com.jhlabs.composite;
...
public class MiscCompositeContext implements CompositeContext {
    ...
    static int clamp(int a) {
        ...
        return a < conditionObj0 ? 0 : a > conditionObj1 ? 255 : a;
    }
    ...
    public void compose(Raster src, Raster dstIn, WritableRaster dstOut) {
        ...
        int conditionObj3 = 127;
        int conditionObj4 = 127;
        int conditionObj5 = 127;
        int conditionObj6 = 127;
        int conditionObj7 = 255;
        int conditionObj8 = 255;
        int conditionObj9 = 255;
        int conditionObj10 = 0;
        int conditionObj11 = 0;
        int conditionObj12 = 0;
        int conditionObj13 = 255;
        int conditionObj14 = 128;
        int conditionObj15 = 128;
        int conditionObj16 = 128;
        int conditionObj17 = 0;
        int conditionObj18 = 0;
        int conditionObj19 = 0;
        int conditionObj20 = 0;
        int conditionObj21 = 0;
        int conditionObj22 = 255;
        int conditionObj23 = 255;
        int conditionObj24 = 255;
        for (int y = y0; y < y1; y++) {
            ...
            while (i < end) {
                ...
                switch(rule) {
                    ...
                    default:
                        dor = dir + sr;
                        if (dor > conditionObj24)
                            dor = 255;
                        dog = dig + sg;
                        if (dog > conditionObj23)
                            dog = 255;
                        dob = dib + sb;
                        if (dob > conditionObj22)
                            dob = 255;
                        break;
                    case MiscComposite.SUBTRACT:
                        dor = dir - sr;
                        if (dor < conditionObj21)
                            dor = 0;
                        dog = dig - sg;
                        if (dog < conditionObj20)
                            dog = 0;
                        dob = dib - sb;
                        if (dob < conditionObj19)
                            dob = 0;
                        break;
                    case MiscComposite.DIFFERENCE:
                        dor = dir - sr;
                        if (dor < conditionObj18)
                            dor = -dor;
                        dog = dig - sg;
                        if (dog < conditionObj17)
                            dog = -dog;
                        dob = dib - sb;
                        if (dob < 0)
                            dob = -dob;
                    ...
                    case MiscComposite.PIN_LIGHT:
                        dor = sr > conditionObj4 ? Math.max(sr, dir) : Math.min(sr, dir);
                        dog = sg > conditionObj3 ? Math.max(sg, dig) : Math.min(sg, dig);
                        dob = sb > conditionObj2 ? Math.max(sb, dib) : Math.min(sb, dib);
                        break;
