...
public class PosterizeFilter extends PointFilter {
    ...
    private void setNumLevelsHelper(int numLevels) {
    ...
    private void initializeHelper() {
        ...
        if (numLevels != conditionObj0)
            for (int i = 0; i < conditionObj1; i++) levels[i] = 255 * (numLevels * i / 256) / (numLevels - 1);
    }
}
