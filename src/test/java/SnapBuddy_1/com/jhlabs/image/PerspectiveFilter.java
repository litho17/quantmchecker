...
public class PerspectiveFilter extends TransformFilter {
    ...
    public void unitSquareToQuad(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3) {
        unitSquareToQuadHelper(y0, y1, y2, y3, x2, x3, x0, x1);
    }
    ...
    private void setClipHelper(boolean clip) {
        this.clip = clip;
    }

    private void unitSquareToQuadHelper(float y0, float y1, float y2, float y3, float x2, float x3, float x0, float x1) {
        this.x0 = x0;
        this.y0 = y0;
        this.x1 = x1;
        this.y1 = y1;
        ...
        int conditionObj0 = 0;
        int conditionObj1 = 0;
        if (dx3 == conditionObj0 && dy3 == conditionObj1) {
            a11 = x1 - x0;
            a21 = x2 - x1;
            a31 = x0;
            a12 = y1 - y0;
    ...
    private void filterHelper(BufferedImage src) {
