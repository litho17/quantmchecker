...
public class SmartBlurFilter extends AbstractBufferedImageOp {
    ...
    private void thresholdBlur(Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, boolean alpha) {
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                ...
                a = af == conditionObj3 ? a1 : a / af;
                r = rf == conditionObj2 ? r1 : r / rf;
                g = gf == conditionObj1 ? g1 : g / gf;
                b = bf == conditionObj0 ? b1 : b / bf;
    ...
    private void setRadiusHelper(int radius) {
        this.hRadius = this.vRadius = radius;
    }

    private void setThresholdHelper(int threshold) {
