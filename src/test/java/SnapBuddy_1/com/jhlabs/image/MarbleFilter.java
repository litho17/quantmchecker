...
public class MarbleFilter extends TransformFilter {
    ...
    public void setTurbulence(float turbulence) {
        setTurbulenceHelper(turbulence);
    }
    ...
    private void setXScaleHelper(float xScale) {
        this.xScale = xScale;
    }

    private void setTurbulenceHelper(float turbulence) {
        this.turbulence = turbulence;
    }

    private void initializeHelper(int i) {
