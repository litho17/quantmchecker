...
public class ConvolveFilter extends AbstractBufferedImageOp {
    ...
    public void setEdgeAction(int edgeAction) {
        setEdgeActionHelper(edgeAction);
    }
    ...
    public void setPremultiplyAlpha(boolean premultiplyAlpha) {
        setPremultiplyAlphaHelper(premultiplyAlpha);
    }
    ...
    public static void convolve(Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, int edgeAction) {
        convolveHelper(outPixels, height, inPixels, width, edgeAction, kernel);
    }
    ...
    public static void convolve(Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, boolean alpha, int edgeAction) {
        int conditionObj0 = 1;
        int conditionObj1 = 1;
        if (kernel.getHeight() == conditionObj0)
            convolveH(kernel, inPixels, outPixels, width, height, alpha, edgeAction);
        else if (kernel.getWidth() == conditionObj1)
    ...
    private void setKernelHelper(Kernel kernel) {
        this.kernel = kernel;
    }

    private void setEdgeActionHelper(int edgeAction) {
        this.edgeAction = edgeAction;
    }

    private void setUseAlphaHelper(boolean useAlpha) {
        this.alpha = useAlpha;
    }

    private void setPremultiplyAlphaHelper(boolean premultiplyAlpha) {
        this.premultiplyAlpha = premultiplyAlpha;
    }

    private static void convolveHelper(int[] outPixels, int height, int[] inPixels, int width, int edgeAction, Kernel kernel) {
