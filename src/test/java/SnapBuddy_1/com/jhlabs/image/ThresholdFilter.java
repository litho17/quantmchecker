...
public class ThresholdFilter extends PointFilter {
    ...
    public void setLowerThreshold(int lowerThreshold) {
        setLowerThresholdHelper(lowerThreshold);
    }
    ...
    private void setLowerThresholdHelper(int lowerThreshold) {
        this.lowerThreshold = lowerThreshold;
    }

    private void setBlackHelper(int black) {
        this.black = black;
    }
}
