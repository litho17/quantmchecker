...
public class PolarFilter extends TransformFilter {
    ...
    private void transformInverseHelper(float ny, float nx, float[] out) {
        out[0] = (float) centreX - nx;
        out[1] = (float) centreY - ny;
    }

    private void transformInverseHelper1(float ny, float nx, float[] out) {
        out[0] = (float) centreX + nx;
        out[1] = (float) centreY + ny;
    }
}
