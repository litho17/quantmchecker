...
public class FBMFilter extends PointFilter implements Cloneable {
    ...
    private void setScaleHelper(float scale) {
        this.scale = scale;
    }

    private void setOctavesHelper(float octaves) {
        this.octaves = octaves;
    }

    private void setHHelper(float H) {
        this.H = H;
    }
