...
public class BrushedMetalFilter implements BufferedImageOp {
    ...
    private int random(int x) {
        ...
        int conditionObj0 = 0;
        int conditionObj1 = 0xff;
        if (x < conditionObj0)
            x = 0;
        else if (x > conditionObj1)
            x = 0xff;
        return x;
    }
    ...
    public void setMonochrome(boolean monochrome) {
        setMonochromeHelper(monochrome);
    }
    ...
    private void setMonochromeHelper(boolean monochrome) {
        this.monochrome = monochrome;
    }

    private void setRGBHelper(int height, int width, BufferedImage image, int[] pixels, int y, int x) {
