...
public class SkyFilter extends PointFilter {
    ...
    public void setCloudSharpness(float cloudSharpness) {
        setCloudSharpnessHelper(cloudSharpness);
    }
    ...
    public void setSunElevation(float sunElevation) {
        setSunElevationHelper(sunElevation);
    }
    ...
    public void setCameraAzimuth(float cameraAzimuth) {
        setCameraAzimuthHelper(cameraAzimuth);
    }
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        int h = src.getHeight();
        tan = new float[h];
        for (int i = 0; i < h; i++) tan[i] = (float) Math.tan(fov * (float) i / h * Math.PI * 0.5);
        if (dst == null)
...
*/
    ...
    private void setTHelper(float t) {
        this.t = t;
    }

    private void setCloudSharpnessHelper(float cloudSharpness) {
        this.cloudSharpness = cloudSharpness;
    }

    private void setAngleHelper(float angle) {
        this.angle = angle;
    }

    private void setHazinessHelper(float haziness) {
        this.haziness = haziness;
    }

    private void setSunElevationHelper(float sunElevation) {
        this.sunElevation = sunElevation;
    }

    private void setCameraAzimuthHelper(float cameraAzimuth) {
