...
public class InterpolateFilter extends AbstractBufferedImageOp {
    ...
    public void setDestination(BufferedImage destination) {
        setDestinationHelper(destination);
    }
    ...
    public void setInterpolation(float interpolation) {
        setInterpolationHelper(interpolation);
    }
        ...
        if (destination != null) {
            ...
            for (int y = 0; y < height; y++) {
                ...
                for (int x = 0; x < width; x++) {
                    filterHelper(pixels1, pixels2, x);
                }
    ...
    private void setDestinationHelper(BufferedImage destination) {
        this.destination = destination;
    }

    private void setInterpolationHelper(float interpolation) {
        this.interpolation = interpolation;
    }

    private void filterHelper(int[] pixels1, int[] pixels2, int x) {
        int rgb1 = pixels1[x];
        int rgb2 = pixels2[x];
        int a1 = (rgb1 >> 24) & 0xff;
        int r1 = (rgb1 >> 16) & 0xff;
