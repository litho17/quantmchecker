...
public class FeedbackFilter extends AbstractBufferedImageOp {
    ...
    private void setEndAlphaHelper(float endAlpha) {
    ...
    private void setCentreHelper(Point2D centre) {
