...
public class Spectrum {
    ...
    public static int wavelengthToRGB(float wavelength) {
        ...
        int conditionObj0 = 440;
        int conditionObj1 = 490;
        int conditionObj2 = 510;
        int conditionObj3 = 580;
        int conditionObj4 = 645;
        int conditionObj5 = 780;
        if (w < 380) {
            r = 0.0f;
            g = 0.0f;
            b = 0.0f;
        } else if (w < conditionObj0) {
            r = -(wavelength - 440) / (440 - 380);
            g = 0.0f;
            b = 1.0f;
        } else if (w < conditionObj1) {
            r = 0.0f;
            g = (wavelength - 440) / (490 - 440);
            b = 1.0f;
        } else if (w < conditionObj2) {
            r = 0.0f;
            g = 1.0f;
            b = -(wavelength - 510) / (510 - 490);
        } else if (w < conditionObj3) {
            r = (wavelength - 510) / (580 - 510);
            g = 1.0f;
            b = 0.0f;
        } else if (w < conditionObj4) {
            r = 1.0f;
            g = -(wavelength - 645) / (645 - 580);
            b = 0.0f;
        } else if (w <= conditionObj5) {
            r = 1.0f;
            g = 0.0f;
            b = 0.0f;
        } else {
        ...
        int conditionObj6 = 700;
        int conditionObj7 = 419;
        // Let the intensity fall off near the vision limits
        if (380 <= w && w <= conditionObj7)
            factor = 0.3f + 0.7f * (wavelength - 380) / (420 - 380);
        else if (420 <= w && w <= conditionObj6)
            factor = 1.0f;
        else if (701 <= w && w <= 780)
