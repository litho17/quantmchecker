...
public class ChannelMixFilter extends PointFilter {
    ...
    private void setBlueGreenHelper(int blueGreen) {
        this.blueGreen = blueGreen;
    }

    private void setRedBlueHelper(int redBlue) {
        this.redBlue = redBlue;
    }

    private void setGreenRedHelper(int greenRed) {
