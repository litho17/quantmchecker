...
public class FilterHandler extends AbstractTemplateSnapBuddyHandler {
    ...
    private void createDropDownBoxHelper(StringBuilder sb) {
        sb.append("selected");
    }

    private void createDropDownBoxHelper1(StringBuilder sb) {
        sb.append("\">");
    }
}
