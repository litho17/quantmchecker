...
import SnapBuddy_1.com.cyberpointllc.stac.webserver.handler.AuthenticationHandler;
import SnapBuddy_1.com.cyberpointllc.stac.webserver.handler.LoginFilter;
import SnapBuddy_1.com.cyberpointllc.stac.webserver.handler.LoginHandler;
import SnapBuddy_1.com.cyberpointllc.stac.webserver.handler.LogoutHandler;
...
public class WebServer {
    ...
    public void addAuthHandlers(UserManager userManager, String loginDestinationPath) throws IOException {
        addAuthHandlersHelper(loginDestinationPath, userManager);
    }
    ...
    private void addAuthHandlersHelper(String loginDestinationPath, UserManager userManager) throws IOException {
    ...
    private void createContextHelper(HttpContext context) {
