...
public class HttpHandlerResponse {
    ...
    protected void addResponseHeaders(HttpExchange httpExchange) throws IOException {
        addResponseHeadersHelper(httpExchange);
    }
    ...
    public void sendResponse(HttpExchange httpExchange) throws IOException {
        sendResponseHelper(httpExchange);
    }

    private void addResponseHeadersHelper(HttpExchange httpExchange) throws IOException {
    ...
    private void sendResponseHelper(HttpExchange httpExchange) throws IOException {
