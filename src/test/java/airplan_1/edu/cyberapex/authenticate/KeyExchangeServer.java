package airplan_1.edu.cyberapex.authenticate;

import airplan_1.edu.cyberapex.algorithm.ModularPower;
...
public class KeyExchangeServer {
    ...
    public KeyExchangeServer(String secretKey, String floormod, String generator) {
        this(stringToBigInt(secretKey), stringToBigInt(floormod), stringToBigInt(generator));
    }
    ...
    public KeyExchangeServer() {
        this(generateRandomSecret(), stringToBigInt(DEFAULT_MODULUS), DEFAULT_GENERATOR);
    }
    ...
    public BigInteger generateMasterSecret(BigInteger clientPublic) {
        return ModularPower.modularPower(clientPublic, secretKey, floormod);
    }
