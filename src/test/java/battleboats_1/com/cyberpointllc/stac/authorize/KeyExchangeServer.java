package battleboats_1.com.cyberpointllc.stac.authorize;

import battleboats_1.com.cyberpointllc.stac.numerical.WrapPow;
...
public class KeyExchangeServer {
    ...
    private static final String DEFAULT_MODULO = "";
    private static final BigInteger DEFAULT_PRODUCER = BigInteger.valueOf(2);
    ...
    public KeyExchangeServer(String secretKey) {
        this(stringToBigInt(secretKey), stringToBigInt(DEFAULT_MODULO), DEFAULT_PRODUCER);
    }

    // Constructor that uses the modp1536 group and a random secret exponent
    public KeyExchangeServer() {
        this(makeRandomSecret(), stringToBigInt(DEFAULT_MODULO), DEFAULT_PRODUCER);
    }
    ...
    public BigInteger generateMasterSecret(BigInteger clientPublic) {
        return WrapPow.wrapPow(clientPublic, secretKey, modulo);
    }
