...
/**
 * This class is used to verify that the user is connected to the real host.
 ...
 * The user then copies their public key into the authentication page and presses
 ...
 */
public class KeyExchangeAuthenticator {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            String serversPublicKeyString = grabServerKey(args[1]);
    ...
    private static String grabServerKey(String serverKeyPath) throws IOException {
        File serverKeyFile = new File(serverKeyPath);
        StringWriter stringWriter = new StringWriter();
        try (InputStream inputStream = FileUtils.openInputStream(serverKeyFile)) {
