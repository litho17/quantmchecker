package powerbroker_1.edu.networkcusp.buyOp.messagedata;

import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.AuctionEndMsg;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.AuctionMsg;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.AuctionMsg.Type;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.AuctionStartMsg;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.BidCommitmentMsg;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.BidComparisonMsg;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.BigIntegerMsg;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProtos.RevealBidMsg;
	...
	public AuctionMessageData deserialize(byte[] bytes) throws IOException{
		try{
	    	...
	    	case BID_COMPARISON:
				...
				int q = 0;
                for (int i1 = 0; i1 < compareMsg.values_.size(); i1++) {
                    BigIntegerMsg bigIntMsg = compareMsg.values_.get(i1);
