package powerbroker_1.edu.networkcusp.authenticate;

import powerbroker_1.edu.networkcusp.math.CircularPower;
...
public class KeyExchangeServer {
    ...
    public KeyExchangeServer(BigInteger secretKey, BigInteger modulo, BigInteger generator) {
        this.secretKey = secretKey;
        this.modulo = modulo;
        this.generator = generator;
        this.publicKey = this.generator.modPow(this.secretKey, this.modulo);
    }

    // Constructor for user specified key exponent, modulus and generator
    // Should be used rarely
    public KeyExchangeServer(String secretKey, String modulo, String generator) {
        this(stringToBigInt(secretKey), stringToBigInt(modulo), stringToBigInt(generator));
    }
    ...
    public KeyExchangeServer() {
        this(formRandomSecret(), stringToBigInt(DEFAULT_MODULUS), DEFAULT_GENERATOR);
    }
    ...
    public BigInteger generateMasterSecret(BigInteger clientPublic) {
        return CircularPower.circularPower(clientPublic, secretKey, modulo);
    }
