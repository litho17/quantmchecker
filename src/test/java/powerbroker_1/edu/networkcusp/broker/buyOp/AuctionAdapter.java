package powerbroker_1.edu.networkcusp.broker.buyOp;

import powerbroker_1.edu.networkcusp.buyOp.AuctionHandler;
import powerbroker_1.edu.networkcusp.buyOp.AuctionProcessor;
import powerbroker_1.edu.networkcusp.buyOp.AuctionCustomerAPI;
...
import powerbroker_1.edu.networkcusp.buyOp.messagedata.AuctionProtoSerializer;
...
public class AuctionAdapter implements Communicator, AuctionCustomerAPI {
    ...
    public final Map<ProtocolsPublicIdentity, OfferConveyData> claimsReceived =
