...
public class Driver {
    ...
    public void main(List<Object> input) throws Exception {
        @Bound("* 5 input") int i;
        @Inv("and (= (- auction.biddersStatus.biddersNotReported it it it) (- (+ c28 c29 c29) c27 c27 c27)) (= (- auction.proposals it it) (- (+ c28 c29) c27 c27)) (= (- auction.biddersStatus.conceders it) (- c30 c27)) (= auction.biddersStatus.claimedWinners 0) (= auction.proposals 0)") Auction auction = null;
