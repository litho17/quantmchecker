...
import infotrader.src.infotrader.sitedatastorage.ReadDirStruct;
import infotrader.src.infotrader.datamodel.Directory;
import infotrader.src.infotrader.datamodel.DocumentI;
import infotrader.src.infotrader.datamodel.HyperLink;
import infotrader.src.infotrader.datamodel.Node;
import infotrader.src.infotrader.datamodel.NodeBase;
import infotrader.src.infotrader.datamodel.SerializationPosition;
import infotrader.src.infotrader.sitedatastorage.DocumentStore;
import java.io.File;
...
public class SiteMapGenerator {
    ...
    public static void serializeNode(SerializationPosition state) {
        ...
        if ((Node) state.currPos.getUserObject() instanceof HyperLink) {
            ...
            if (infotrader.src.infotrader.datamodel.HyperLink.links_to_existing()) {
        ...
        if (infotrader.src.infotrader.datamodel.Directory.isa(state.currPos.getUserObject().toString(), state) && serializedXMLElement == null) {
            ...
            // a Directory.
            serializedXMLElement = infotrader.src.infotrader.datamodel.Directory.exists(state.currPos.getUserObject().toString(), state);

            if (serializedXMLElement == null) {
                serializedXMLElement = userObject.serialize((Node) userObject, state);
            }

        } else if ((Node) state.currPos.getUserObject() instanceof infotrader.src.infotrader.datamodel.DocumentI && serializedXMLElement == null) { // Determined using reflection, not name
