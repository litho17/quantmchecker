package infotrader.src.infotrader.userinteraction;

import infotrader.src.infotrader.dataprocessing.DocumentDisplayGenerator;
import infotrader.src.infotrader.sitedatastorage.ReadDirStruct;
import infotrader.src.infotrader.dataprocessing.NodeCreationException;
import infotrader.src.infotrader.dataprocessing.SiteMapGenerator;
...
import infotrader.src.infotrader.sitedatastorage.DocumentStore.FileLink;
import java.io.BufferedReader;
import java.io.FileReader;
import java.util.ArrayList;
import java.util.HashMap;

import static infotrader.src.infotrader.messaging.controller.module.RunInfoTrader.clean;
