...
public class ModerationService {
	...
	public void deleteTopics(List<Topic> topics, ModerationLog moderationLog) {
		@Bound("topics") int i;
		@Inv("= (- topicsForModeration it) (- c107 c106)") List<Topic> topicsForModeration = new ArrayList<Topic>();

		@Iter("<= it topics") Iterator<Topic> it = topics.iterator();
		while (it.hasNext()) {
			Topic topic;
			c106: topic = it.next();
			c107: topicsForModeration.add(this.topicRepository.get(topic.getId()));
