...
public class ForumController {
	...
	public void newMessages(int page) {
		...
		@InvUnk("Extend library class") PaginatedResult<Topic> newMessages = this.forumRepository.getNewMessages(new Date(userSession.getLastVisit()),
	...
	public void show(int forumId, int page) {
		...
		@InvUnk("Extend library class") Pagination pagination = new Pagination(this.config, page).forForum(forum);
