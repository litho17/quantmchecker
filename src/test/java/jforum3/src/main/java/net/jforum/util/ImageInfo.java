...
/*	public static final int COLOR_TYPE_UNKNOWN = -1;
            ...
            switch (blockType) {
                ...
                case (0x21): // extension
                {
                    ...
                    if (collectComments && extensionType == 0xfe) {
                        @Bound("this.in") int j;
                        @Inv("= (- sb this.in) (- c437 c433 c426)") StringBuffer sb = new StringBuffer();
                        int n;
                        do {
                            c426: n = read();
                            if (n == -1) {
    ...
    public static void main(String[] args) {
        @InvUnk("Complex loop") ImageInfo imageInfo = new ImageInfo();
