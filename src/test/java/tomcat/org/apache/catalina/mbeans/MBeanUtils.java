 ...
 */
package tomcat.org.apache.catalina.mbeans;
...
import tomcat.org.apache.catalina.Group;
import tomcat.org.apache.catalina.Loader;
import tomcat.org.apache.catalina.Role;
import tomcat.org.apache.catalina.Server;
import tomcat.org.apache.catalina.User;
import tomcat.org.apache.catalina.UserDatabase;
...
import tomcat.org.apache.tomcat.util.descriptor.web.ContextResourceLink;
import tomcat.org.apache.tomcat.util.modeler.ManagedBean;
import tomcat.org.apache.tomcat.util.modeler.Registry;
...
public class MBeanUtils {
    ...
    private static final String exceptions[][] = {
        { "tomcat.org.apache.catalina.users.MemoryGroup",
          "Group" },
        { "tomcat.org.apache.catalina.users.MemoryRole",
          "Role" },
        { "tomcat.org.apache.catalina.users.MemoryUser",
          "User" },
    };
    ...
    public static synchronized Registry createRegistry() {
        if (registry == null) {
            ...
            registry.loadDescriptors("tomcat.org.apache.catalina.mbeans",  cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.authenticator", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.core", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.deploy", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.loader", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.realm", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.session", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.startup", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.users", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.ha", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.connector", cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.valves",  cl);
            registry.loadDescriptors("tomcat.org.apache.catalina.storeconfig",  cl);
            registry.loadDescriptors("tomcat.org.apache.tomcat.util.descriptor.web",  cl);
        }
        return registry;
    }
    ...
    public static void destroyMBean(ContextResource resource)
        ...
        if ("tomcat.org.apache.catalina.UserDatabase".equals(resource.getType())) {
