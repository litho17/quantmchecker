...
import tomcat.javax.servlet.Filter;
import tomcat.javax.servlet.FilterConfig;
import tomcat.javax.servlet.FilterRegistration;
import tomcat.javax.servlet.RequestDispatcher;
import tomcat.javax.servlet.Servlet;
...
import tomcat.javax.servlet.ServletContextEvent;
import tomcat.javax.servlet.ServletContextListener;
import tomcat.javax.servlet.ServletException;
import tomcat.javax.servlet.ServletRegistration;
import tomcat.javax.servlet.ServletRegistration.Dynamic;
import tomcat.javax.servlet.ServletRequest;
import tomcat.javax.servlet.ServletRequestAttributeListener;
import tomcat.javax.servlet.ServletRequestEvent;
import tomcat.javax.servlet.ServletRequestListener;
import tomcat.javax.servlet.ServletSecurityElement;
import tomcat.javax.servlet.SessionCookieConfig;
import tomcat.javax.servlet.SessionTrackingMode;
import tomcat.javax.servlet.descriptor.JspConfigDescriptor;
...
import tomcat.org.apache.catalina.Authenticator;
import tomcat.org.apache.catalina.Container;
import tomcat.org.apache.catalina.ContainerListener;
import tomcat.org.apache.catalina.Context;
import tomcat.org.apache.catalina.CredentialHandler;
import tomcat.org.apache.catalina.Globals;
import tomcat.org.apache.catalina.Lifecycle;
import tomcat.org.apache.catalina.LifecycleException;
import tomcat.org.apache.catalina.LifecycleListener;
import tomcat.org.apache.catalina.LifecycleState;
import tomcat.org.apache.catalina.Loader;
import tomcat.org.apache.catalina.Manager;
import tomcat.org.apache.catalina.Pipeline;
import tomcat.org.apache.catalina.Realm;
import tomcat.org.apache.catalina.ThreadBindingListener;
import tomcat.org.apache.catalina.Valve;
import tomcat.org.apache.catalina.WebResource;
import tomcat.org.apache.catalina.WebResourceRoot;
import tomcat.org.apache.catalina.Wrapper;
import tomcat.org.apache.catalina.deploy.NamingResourcesImpl;
import tomcat.org.apache.catalina.loader.WebappLoader;
import tomcat.org.apache.catalina.session.StandardManager;
import tomcat.org.apache.catalina.util.CharsetMapper;
import tomcat.org.apache.catalina.util.ContextName;
import tomcat.org.apache.catalina.util.ErrorPageSupport;
import tomcat.org.apache.catalina.util.ExtensionValidator;
import tomcat.org.apache.catalina.util.URLEncoder;
import tomcat.org.apache.catalina.webresources.StandardRoot;
import tomcat.org.apache.juli.logging.Log;
import tomcat.org.apache.juli.logging.LogFactory;
import tomcat.org.apache.naming.ContextBindings;
import tomcat.org.apache.tomcat.InstanceManager;
import tomcat.org.apache.tomcat.InstanceManagerBindings;
import tomcat.org.apache.tomcat.JarScanner;
import tomcat.org.apache.tomcat.util.ExceptionUtils;
import tomcat.org.apache.tomcat.util.IntrospectionUtils;
import tomcat.org.apache.tomcat.util.buf.StringUtils;
import tomcat.org.apache.tomcat.util.descriptor.XmlIdentifiers;
import tomcat.org.apache.tomcat.util.descriptor.web.ApplicationParameter;
import tomcat.org.apache.tomcat.util.descriptor.web.ErrorPage;
import tomcat.org.apache.tomcat.util.descriptor.web.FilterDef;
import tomcat.org.apache.tomcat.util.descriptor.web.FilterMap;
import tomcat.org.apache.tomcat.util.descriptor.web.Injectable;
import tomcat.org.apache.tomcat.util.descriptor.web.InjectionTarget;
import tomcat.org.apache.tomcat.util.descriptor.web.LoginConfig;
import tomcat.org.apache.tomcat.util.descriptor.web.MessageDestination;
import tomcat.org.apache.tomcat.util.descriptor.web.MessageDestinationRef;
import tomcat.org.apache.tomcat.util.descriptor.web.SecurityCollection;
import tomcat.org.apache.tomcat.util.descriptor.web.SecurityConstraint;
import tomcat.org.apache.tomcat.util.http.CookieProcessor;
import tomcat.org.apache.tomcat.util.http.Rfc6265CookieProcessor;
import tomcat.org.apache.tomcat.util.scan.StandardJarScanner;
import tomcat.org.apache.tomcat.util.security.PrivilegedGetTccl;
import tomcat.org.apache.tomcat.util.security.PrivilegedSetTccl;
...
public class StandardContext extends ContainerBase
    ...
    private String charsetMapperClass =
      "tomcat.org.apache.catalina.util.CharsetMapper";
     ...
     * of {@link tomcat.org.apache.catalina.util.LifecycleBase#startInternal()}.
     *
     ...
     * of {@link tomcat.org.apache.catalina.util.LifecycleBase#stopInternal()}.
     *
     * @exception LifecycleException if this component detects a fatal error
     *  that prevents this component from being used
     */
