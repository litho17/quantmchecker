...
import tomcat.org.apache.catalina.AsyncDispatcher;
...
import tomcat.org.apache.catalina.connector.ClientAbortException;
 ...
 * <code>ServletRequestWrapper</code> and
...
final class ApplicationDispatcher implements AsyncDispatcher, RequestDispatcher {
    ...
    static {
        ...
        String wrapSameObject = System.getProperty(
                "tomcat.org.apache.catalina.core.ApplicationDispatcher.WRAP_SAME_OBJECT");
