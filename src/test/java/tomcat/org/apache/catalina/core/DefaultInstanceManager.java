...
import tomcat.javax.annotation.PostConstruct;
import tomcat.javax.annotation.PreDestroy;
import tomcat.javax.annotation.Resource;
import tomcat.javax.ejb.EJB;
import javax.naming.Context;
import javax.naming.NamingException;
import tomcat.javax.persistence.PersistenceContext;
import tomcat.javax.persistence.PersistenceUnit;
import tomcat.javax.xml.ws.WebServiceRef;
...
import tomcat.org.apache.tomcat.util.collections.ManagedConcurrentWeakHashMap;
...
public class DefaultInstanceManager implements InstanceManager {
    ...
    static {
        Class<?> clazz = null;
        try {
            clazz = Class.forName("tomcat.javax.ejb.EJB");
        ...
        clazz = null;
        try {
            clazz = Class.forName("tomcat.javax.persistence.PersistenceContext");
        } catch (ClassNotFoundException cnfe) {
            // Expected
        }
        ...
        clazz = null;
        try {
            clazz = Class.forName("tomcat.javax.xml.ws.WebServiceRef");
        } catch (ClassNotFoundException cnfe) {
            // Expected
        }
    ...
    public DefaultInstanceManager(Context context,
            ...
            tomcat.org.apache.catalina.Context catalinaContext,
    ...
    protected Class<?> loadClass(String className, ClassLoader classLoader)
        ...
        if (className.startsWith("tomcat.org.apache.catalina")) {
