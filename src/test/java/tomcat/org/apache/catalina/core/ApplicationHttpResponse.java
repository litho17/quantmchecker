...
/**
 * Wrapper around a <code>HttpServletResponse</code>
 * that transforms an application response object (which might be the original
 * one passed to a servlet, or might be based on the 2.3
 * <code>HttpServletResponseWrapper</code> class)
 * back into an internal <code>tomcat.org.apache.catalina.HttpResponse</code>.
 * <p>
