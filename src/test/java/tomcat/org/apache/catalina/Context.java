...
import tomcat.org.apache.tomcat.ContextBind;
...
public interface Context extends Container, ContextBind {
   ...
   /**
    ...
    /**
     * Notify all {@link ServletRequestListener}s that a request
     * has started.
     *
     ...
     * to {@link HttpServletResponse#sendRedirect(String)}
     ...
     * {@link tomcat.org.apache.catalina.filters.RemoteIpFilter} if the filter is
     ...
     * {@link HttpServletResponse#sendRedirect(String)} use
