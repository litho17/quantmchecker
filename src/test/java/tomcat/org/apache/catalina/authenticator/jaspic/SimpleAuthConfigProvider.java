...
import tomcat.javax.security.auth.message.config.ClientAuthConfig;
import tomcat.javax.security.auth.message.config.ServerAuthConfig;
import tomcat.javax.security.auth.message.module.ServerAuthModule;

/**
 * Basic implementation primarily intended for use when using third-party
 * {@link ServerAuthModule} implementations
