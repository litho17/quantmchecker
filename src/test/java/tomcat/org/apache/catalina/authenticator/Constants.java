...
public class Constants {
    ...
    public static final String SINGLE_SIGN_ON_COOKIE =
        System.getProperty(
                "tomcat.org.apache.catalina.authenticator.Constants.SSO_SESSION_COOKIE_NAME",
                "JSESSIONIDSSO");
    ...
    public static final String REQ_SSOID_NOTE =
            "tomcat.org.apache.catalina.request.SSOID";


    public static final String REQ_JASPIC_SUBJECT_NOTE =
            "tomcat.org.apache.catalina.authenticator.jaspic.SUBJECT";
    ...
    public static final String SESS_PASSWORD_NOTE =
      "tomcat.org.apache.catalina.session.PASSWORD";
    ...
    public static final String SESS_USERNAME_NOTE =
      "tomcat.org.apache.catalina.session.USERNAME";
    ...
    public static final String FORM_PRINCIPAL_NOTE =
        "tomcat.org.apache.catalina.authenticator.PRINCIPAL";
    ...
    public static final String FORM_REQUEST_NOTE =
        "tomcat.org.apache.catalina.authenticator.REQUEST";
