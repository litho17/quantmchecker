...
import tomcat.javax.servlet.http.HttpServletResponseWrapper;
...
import tomcat.org.apache.catalina.security.SecurityUtil;
...
import tomcat.org.apache.tomcat.util.buf.UEncoder;
import tomcat.org.apache.tomcat.util.buf.UEncoder.SafeCharsSet;
...
import tomcat.org.apache.tomcat.util.http.parser.MediaTypeCache;
...
public class Response implements HttpServletResponse {
    ...
    static {
        ENFORCE_ENCODING_IN_GET_WRITER = Boolean.parseBoolean(
                System.getProperty("tomcat.org.apache.catalina.connector.Response.ENFORCE_ENCODING_IN_GET_WRITER",
                        "true"));
    }
     ...
     * Coyote response.
     */
    protected tomcat.org.apache.coyote.Response coyoteResponse;
     ...
     */
    public void setCoyoteResponse(tomcat.org.apache.coyote.Response coyoteResponse) {
     ...
     */
    public tomcat.org.apache.coyote.Response getCoyoteResponse() {
     ...
     */
    public tomcat.org.apache.catalina.connector.Request getRequest() {
        return this.request;
    }
     ...
     */
    public void setRequest(tomcat.org.apache.catalina.connector.Request request) {
    ...
    public String getCharacterEncoding() {
        ...
        if (result == null) {
            result = tomcat.org.apache.coyote.Constants.DEFAULT_BODY_CHARSET.name();
        }
    ...
    /**
     * An extended version of this exists in {@link tomcat.org.apache.coyote.Response}.
     ...
     * visible to {@link tomcat.org.apache.coyote.Response}
     *
