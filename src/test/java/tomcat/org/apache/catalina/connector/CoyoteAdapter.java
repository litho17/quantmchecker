...
import tomcat.javax.servlet.ReadListener;
...
import tomcat.javax.servlet.WriteListener;
...
import tomcat.org.apache.catalina.authenticator.AuthenticatorBase;
import tomcat.org.apache.catalina.core.AsyncContextImpl;
import tomcat.org.apache.catalina.util.ServerInfo;
import tomcat.org.apache.catalina.util.SessionConfig;
...
import tomcat.org.apache.tomcat.util.buf.CharChunk;
...
public class CoyoteAdapter implements Adapter {
    ...
    protected static final boolean ALLOW_BACKSLASH =
        Boolean.parseBoolean(System.getProperty("tomcat.org.apache.catalina.connector.CoyoteAdapter.ALLOW_BACKSLASH", "false"));
    ...
    @Override
    public boolean asyncDispatch(tomcat.org.apache.coyote.Request req, tomcat.org.apache.coyote.Response res,
    ...
    @Override
    public void service(tomcat.org.apache.coyote.Request req, tomcat.org.apache.coyote.Response res)
            throws Exception {
    ...
    @Override
    public boolean prepare(tomcat.org.apache.coyote.Request req, tomcat.org.apache.coyote.Response res)
    ...
    @Override
    public void log(tomcat.org.apache.coyote.Request req,
            tomcat.org.apache.coyote.Response res, long time) {
    ...
    @Override
    public void checkRecycled(tomcat.org.apache.coyote.Request req,
            tomcat.org.apache.coyote.Response res) {
        Request request = (Request) req.getNote(ADAPTER_NOTES);
        Response response = (Response) res.getNote(ADAPTER_NOTES);
     ...
     */
    protected boolean postParseRequest(tomcat.org.apache.coyote.Request req, Request request,
            tomcat.org.apache.coyote.Response res, Response response) throws IOException, ServletException {
    ...
    private void doConnectorAuthenticationAuthorization(tomcat.org.apache.coyote.Request req, Request request) {
     ...
     */
    protected void parsePathParameters(tomcat.org.apache.coyote.Request req,
            Request request) {
