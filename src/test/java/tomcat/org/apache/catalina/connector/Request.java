...
import tomcat.javax.servlet.AsyncContext;
import tomcat.javax.servlet.DispatcherType;
import tomcat.javax.servlet.FilterChain;
import tomcat.javax.servlet.MultipartConfigElement;
...
import tomcat.javax.servlet.ServletRequest;
import tomcat.javax.servlet.ServletRequestAttributeEvent;
import tomcat.javax.servlet.ServletRequestAttributeListener;
import tomcat.javax.servlet.ServletResponse;
import tomcat.javax.servlet.SessionTrackingMode;
import tomcat.javax.servlet.http.Cookie;
import tomcat.javax.servlet.http.HttpServletMapping;
import tomcat.javax.servlet.http.HttpServletRequest;
import tomcat.javax.servlet.http.HttpServletRequestWrapper;
import tomcat.javax.servlet.http.HttpServletResponse;
import tomcat.javax.servlet.http.HttpSession;
import tomcat.javax.servlet.http.HttpUpgradeHandler;
import tomcat.javax.servlet.http.HttpSessionIdListener;
import tomcat.javax.servlet.http.Part;
import tomcat.javax.servlet.http.PushBuilder;

import tomcat.org.apache.catalina.Container;
import tomcat.org.apache.catalina.Context;
import tomcat.org.apache.catalina.Globals;
import tomcat.org.apache.catalina.Host;
import tomcat.org.apache.catalina.Manager;
import tomcat.org.apache.catalina.Realm;
import tomcat.org.apache.catalina.Session;
import tomcat.org.apache.catalina.TomcatPrincipal;
import tomcat.org.apache.catalina.Wrapper;
import tomcat.org.apache.catalina.core.ApplicationFilterChain;
import tomcat.org.apache.catalina.core.ApplicationMapping;
import tomcat.org.apache.catalina.core.ApplicationPart;
import tomcat.org.apache.catalina.core.ApplicationPushBuilder;
import tomcat.org.apache.catalina.core.ApplicationSessionCookieConfig;
import tomcat.org.apache.catalina.core.AsyncContextImpl;
import tomcat.org.apache.catalina.mapper.MappingData;
import tomcat.org.apache.catalina.util.ParameterMap;
import tomcat.org.apache.catalina.util.RequestUtil;
import tomcat.org.apache.catalina.util.TLSUtil;
import tomcat.org.apache.catalina.util.URLEncoder;
import tomcat.org.apache.coyote.ActionCode;
...
import tomcat.org.apache.tomcat.util.ExceptionUtils;
import tomcat.org.apache.tomcat.util.buf.B2CConverter;
import tomcat.org.apache.tomcat.util.buf.ByteChunk;
import tomcat.org.apache.tomcat.util.buf.MessageBytes;
import tomcat.org.apache.tomcat.util.buf.StringUtils;
import tomcat.org.apache.tomcat.util.buf.UDecoder;
import tomcat.org.apache.tomcat.util.http.CookieProcessor;
import tomcat.org.apache.tomcat.util.http.FastHttpDateFormat;
import tomcat.org.apache.tomcat.util.http.Parameters;
import tomcat.org.apache.tomcat.util.http.Parameters.FailReason;
import tomcat.org.apache.tomcat.util.http.ServerCookie;
import tomcat.org.apache.tomcat.util.http.ServerCookies;
import tomcat.org.apache.tomcat.util.http.fileupload.FileItem;
import tomcat.org.apache.tomcat.util.http.fileupload.FileUploadBase;
import tomcat.org.apache.tomcat.util.http.fileupload.FileUploadBase.InvalidContentTypeException;
import tomcat.org.apache.tomcat.util.http.fileupload.FileUploadException;
import tomcat.org.apache.tomcat.util.http.fileupload.disk.DiskFileItemFactory;
import tomcat.org.apache.tomcat.util.http.fileupload.servlet.ServletFileUpload;
import tomcat.org.apache.tomcat.util.http.fileupload.servlet.ServletRequestContext;
import tomcat.org.apache.tomcat.util.http.parser.AcceptLanguage;
...
public class Request implements HttpServletRequest {
     ...
     * Coyote request.
     */
    protected tomcat.org.apache.coyote.Request coyoteRequest;
     ...
     */
    public void setCoyoteRequest(tomcat.org.apache.coyote.Request coyoteRequest) {
     ...
     */
    public tomcat.org.apache.coyote.Request getCoyoteRequest() {
     ...
     */
    protected tomcat.org.apache.catalina.connector.Response response = null;

    /**
     * @return the Response with which this Request is associated.
     */
    public tomcat.org.apache.catalina.connector.Response getResponse() {
     ...
     */
    public void setResponse(tomcat.org.apache.catalina.connector.Response response) {
     ...
     * have names starting with "tomcat.org.apache.tomcat" and include:
     * <ul>
    ...
    private Charset getCharset() {
        ...
        return tomcat.org.apache.coyote.Constants.DEFAULT_BODY_CHARSET;
    }
    ...
    public void removeAttribute(String name) {
        ...
        if (name.startsWith("tomcat.org.apache.tomcat.")) {
    ...
    public String getContextPath() {
        ...
        candidate = tomcat.org.apache.tomcat.util.http.RequestUtil.normalize(candidate);
