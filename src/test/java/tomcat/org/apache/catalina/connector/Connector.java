...
import tomcat.org.apache.catalina.core.AprLifecycleListener;
import tomcat.org.apache.catalina.util.LifecycleMBeanBase;
import tomcat.org.apache.coyote.Adapter;
import tomcat.org.apache.coyote.ProtocolHandler;
import tomcat.org.apache.coyote.UpgradeProtocol;
import tomcat.org.apache.coyote.ajp.AbstractAjpProtocol;
import tomcat.org.apache.coyote.http11.AbstractHttp11JsseProtocol;
...
import tomcat.org.apache.tomcat.util.net.openssl.OpenSSLImplementation;
...
public class Connector extends LifecycleMBeanBase  {
    ...
    public static final boolean RECYCLE_FACADES =
        Boolean.parseBoolean(System.getProperty("tomcat.org.apache.catalina.connector.RECYCLE_FACADES", "false"));
     ...
     */
    public Connector() {
        this("tomcat.org.apache.coyote.http11.Http11NioProtocol");
    }
    ...
    public Connector(String protocol) {
        ...
        if ("HTTP/1.1".equals(protocol) || protocol == null) {
            if (aprConnector) {
                protocolHandlerClassName = "tomcat.org.apache.coyote.http11.Http11AprProtocol";
            } else {
                protocolHandlerClassName = "tomcat.org.apache.coyote.http11.Http11NioProtocol";
            }
        } else if ("AJP/1.3".equals(protocol)) {
            if (aprConnector) {
                protocolHandlerClassName = "tomcat.org.apache.coyote.ajp.AjpAprProtocol";
            } else {
                protocolHandlerClassName = "tomcat.org.apache.coyote.ajp.AjpNioProtocol";
            }
        } else {
        ...
        setThrowOnFailure(Boolean.getBoolean("tomcat.org.apache.catalina.startup.EXIT_ON_INIT_FAILURE"));
    }
    ...
    public String getProtocol() {
        if (("tomcat.org.apache.coyote.http11.Http11NioProtocol".equals(getProtocolHandlerClassName()) &&
                    (!AprLifecycleListener.isAprAvailable() || !AprLifecycleListener.getUseAprConnector())) ||
                "tomcat.org.apache.coyote.http11.Http11AprProtocol".equals(getProtocolHandlerClassName()) &&
                    AprLifecycleListener.getUseAprConnector()) {
            return "HTTP/1.1";
        } else if (("tomcat.org.apache.coyote.ajp.AjpNioProtocol".equals(getProtocolHandlerClassName()) &&
                    (!AprLifecycleListener.isAprAvailable() || !AprLifecycleListener.getUseAprConnector())) ||
                "tomcat.org.apache.coyote.ajp.AjpAprProtocol".equals(getProtocolHandlerClassName()) &&
                    AprLifecycleListener.getUseAprConnector()) {
            return "AJP/1.3";
        }
    ...
    public String getExecutorName() {
        ...
        if (obj instanceof tomcat.org.apache.catalina.Executor) {
            return ((tomcat.org.apache.catalina.Executor) obj).getName();
        }
    ...
    public Response createResponse() {
        if (protocolHandler instanceof AbstractAjpProtocol<?>) {
            ...
            return new Response(packetSize - tomcat.org.apache.coyote.ajp.Constants.SEND_HEAD_LEN);
        } else {
            return new Response();
        }
    }
