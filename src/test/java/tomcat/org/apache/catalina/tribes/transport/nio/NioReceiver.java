...
import tomcat.org.apache.catalina.tribes.transport.ReceiverBase;
import tomcat.org.apache.catalina.tribes.transport.RxTaskPool;
import tomcat.org.apache.catalina.tribes.util.ExceptionUtils;
...
public class NioReceiver extends ReceiverBase implements Runnable, NioReceiverMBean {
     ...
     *
     * @see tomcat.org.apache.catalina.tribes.ChannelReceiver#start()
     */
    @Override
...
//                    }
     ...
     * Close Selector.
     *
     * @see tomcat.org.apache.catalina.tribes.transport.ReceiverBase#stop()
     */
