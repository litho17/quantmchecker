...
package tomcat.org.apache.catalina.tribes.membership;
...
public class MemberImpl implements Member, java.io.Externalizable {
     ...
     * default is false
     */
    public static final boolean DO_DNS_LOOKUPS = Boolean.parseBoolean(System.getProperty("tomcat.org.apache.catalina.tribes.dns_lookups","false"));
    ...
    public static Member getMember(byte[] data, int offset, int length, MemberImpl member) {
        ...
        if (XByteBuffer.firstIndexOf(data,offset,TRIBES_MBR_BEGIN)!=pos) {
            throw new IllegalArgumentException(sm.getString("memberImpl.invalid.package.begin", tomcat.org.apache.catalina.tribes.util.Arrays.toString(TRIBES_MBR_BEGIN)));
        }
        ...
        if (XByteBuffer.firstIndexOf(data,endpos,TRIBES_MBR_END)!=endpos) {
            throw new IllegalArgumentException(sm.getString("memberImpl.invalid.package.end", tomcat.org.apache.catalina.tribes.util.Arrays.toString(TRIBES_MBR_END)));
        }
        ...
        if ( this.hostname != null ) return hostname;
            ...
            try {
                ...
                if (DO_DNS_LOOKUPS)
                    ...
                    this.hostname = tomcat.org.apache.catalina.tribes.util.Arrays.toString(host,0,host.length,true);
