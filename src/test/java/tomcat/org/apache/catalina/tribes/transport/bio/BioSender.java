...
public class BioSender extends AbstractSender {
     ...
     * @see tomcat.org.apache.catalina.tribes.transport.DataSender#connect()
     */
    @Override
     ...
     *
     * @see tomcat.org.apache.catalina.tribes.transport.DataSender#disconnect()
     */
    @Override
        ...
        try {
            ...
            while ((i != -1) && (bytesRead < Constants.ACK_COMMAND.length)) {
                ...
                if (ackbuf.doesPackageExist() ) {
                    ...
                    ackReceived = Arrays.equals(ackcmd,tomcat.org.apache.catalina.tribes.transport.Constants.ACK_DATA);
                    failAckReceived = Arrays.equals(ackcmd,tomcat.org.apache.catalina.tribes.transport.Constants.FAIL_ACK_DATA);
