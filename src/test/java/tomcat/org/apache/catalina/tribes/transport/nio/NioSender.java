...
public class NioSender extends AbstractSender {
    ...
    protected boolean read() throws IOException {
        ...
        if (ackbuf.doesPackageExist() ) {
            ...
            boolean ack = Arrays.equals(ackcmd,tomcat.org.apache.catalina.tribes.transport.Constants.ACK_DATA);
            boolean fack = Arrays.equals(ackcmd,tomcat.org.apache.catalina.tribes.transport.Constants.FAIL_ACK_DATA);
     ...
     *
     * @throws IOException
     * TODO Implement this tomcat.org.apache.catalina.tribes.transport.IDataSender method
     */
    @Override
