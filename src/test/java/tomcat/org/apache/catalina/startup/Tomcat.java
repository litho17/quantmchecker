...
import tomcat.javax.servlet.SingleThreadModel;
import tomcat.javax.servlet.annotation.WebServlet;
...
import tomcat.org.apache.catalina.authenticator.NonLoginAuthenticator;
import tomcat.org.apache.catalina.connector.Connector;
import tomcat.org.apache.catalina.core.ContainerBase;
import tomcat.org.apache.catalina.core.NamingContextListener;
import tomcat.org.apache.catalina.core.StandardContext;
import tomcat.org.apache.catalina.core.StandardEngine;
import tomcat.org.apache.catalina.core.StandardHost;
import tomcat.org.apache.catalina.core.StandardServer;
import tomcat.org.apache.catalina.core.StandardService;
import tomcat.org.apache.catalina.core.StandardWrapper;
import tomcat.org.apache.catalina.realm.GenericPrincipal;
import tomcat.org.apache.catalina.realm.RealmBase;
 ...
 * implemented in tomcat.org.apache.catalina.startup.Bootstrap.
 *
 * <p>
...
public class Tomcat {
     ...
     * {@link ServletContainerInitializer} processing will be
     * applied.
     *
     ...
     * {@link ServletContainerInitializer} processing and no
     * annotation processing. If a
     * {@link ServletContainerInitializer} is added
     * programmatically, there will still be no scanning for
     * {@link HandlesTypes} matches.
     *
     * <p>
    ...
    static final String[] silences = new String[] {
        "tomcat.org.apache.coyote.http11.Http11NioProtocol",
        "tomcat.org.apache.catalina.core.StandardService",
        "tomcat.org.apache.catalina.core.StandardEngine",
        "tomcat.org.apache.catalina.startup.ContextConfig",
        "tomcat.org.apache.catalina.core.ApplicationContext",
        "tomcat.org.apache.catalina.core.AprLifecycleListener"
    };
    ...
    public void enableNaming() {
        ...
        String value = "tomcat.org.apache.naming";
        String oldValue =
        ...
        if (value == null) {
            System.setProperty
                (javax.naming.Context.INITIAL_CONTEXT_FACTORY,
                 "tomcat.org.apache.naming.java.javaURLContextFactory");
        }
    }
    ...
    public static void initWebappDefaults(Context ctx) {
        ...
        Wrapper servlet = addServlet(
                ctx, "default", "tomcat.org.apache.catalina.servlets.DefaultServlet");
        servlet.setLoadOnStartup(1);
        servlet.setOverridable(true);

        // JSP servlet (by class name - to avoid loading all deps)
        servlet = addServlet(
                ctx, "jsp", "tomcat.org.apache.jasper.servlet.JspServlet");
