...
package tomcat.org.apache.catalina.manager.util;
...
public class SessionUtils {
     ...
     */
    // tomcat.org.apache.struts.Globals.LOCALE_KEY
    private static final String STRUTS_LOCALE_KEY = "tomcat.org.apache.struts.action.LOCALE";//$NON-NLS-1$
    ...
    public static Locale guessLocaleFromSession(final HttpSession in_session) {
        ...
        try {
            ...
            // Tapestry 3.0: Engine stored in session under "tomcat.org.apache.tapestry.engine:" + config.getServletName()
            // TODO: Tapestry 4+
