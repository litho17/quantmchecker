 ...
 */
package tomcat.org.apache.catalina.ha;
...
public class ClusterRuleSet implements RuleSet {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addSetNext(prefix + "Manager",
                            "setManagerTemplate",
                            "tomcat.org.apache.catalina.ha.ClusterManager");
        ...
        digester.addSetNext(prefix + "Channel",
                            "setChannel",
                            "tomcat.org.apache.catalina.tribes.Channel");
        ...
        digester.addSetNext(channelPrefix + "Membership",
                            ...
                            "tomcat.org.apache.catalina.tribes.MembershipService");
        ...
        digester.addSetNext(channelPrefix + "MembershipListener",
                            ...
                            "tomcat.org.apache.catalina.tribes.MembershipListener");
        ...
        digester.addSetNext(channelPrefix + "Sender",
                            "setChannelSender",
                            "tomcat.org.apache.catalina.tribes.ChannelSender");
        ...
        digester.addSetNext(channelPrefix + "Sender/Transport",
                            "setTransport",
                            "tomcat.org.apache.catalina.tribes.transport.MultiPointSender");
        ...
        digester.addSetNext(channelPrefix + "Receiver",
                            "setChannelReceiver",
                            "tomcat.org.apache.catalina.tribes.ChannelReceiver");
        ...
        digester.addSetNext(channelPrefix + "Interceptor",
                            "addInterceptor",
                            "tomcat.org.apache.catalina.tribes.ChannelInterceptor");
        ...
        digester.addSetNext(channelPrefix + "ChannelListener",
                            "addChannelListener",
                            "tomcat.org.apache.catalina.tribes.ChannelListener");
        ...
        digester.addSetNext(prefix + "Deployer",
                            "setClusterDeployer",
                            "tomcat.org.apache.catalina.ha.ClusterDeployer");
        ...
        digester.addSetNext(prefix + "ClusterListener",
                            "addClusterListener",
                            "tomcat.org.apache.catalina.ha.ClusterListener");
