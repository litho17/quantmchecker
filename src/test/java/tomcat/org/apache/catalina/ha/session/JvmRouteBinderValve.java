 ...
 */
package tomcat.org.apache.catalina.ha.session;
...
import tomcat.org.apache.catalina.session.ManagerBase;
import tomcat.org.apache.catalina.session.PersistentManager;
 ...
 * <pre>
 *  &lt;Cluster&gt;
 *  &lt;Valve className=&quot;tomcat.org.apache.catalina.ha.session.JvmRouteBinderValve&quot; /&gt;
 *  &lt;/Cluster&gt;
 * </pre>
 *
 * <br>
...
public class JvmRouteBinderValve extends ValveBase implements ClusterValve {
    ...
    protected String sessionIdAttribute = "tomcat.org.apache.catalina.ha.session.JvmRouteOrignalSessionID";
