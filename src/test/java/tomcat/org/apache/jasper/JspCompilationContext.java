...
import tomcat.org.apache.jasper.compiler.Compiler;
import tomcat.org.apache.jasper.compiler.JspRuntimeContext;
import tomcat.org.apache.jasper.compiler.JspUtil;
import tomcat.org.apache.jasper.compiler.Localizer;
import tomcat.org.apache.jasper.compiler.ServletWriter;
import tomcat.org.apache.jasper.servlet.JasperLoader;
    ...
    public Compiler createCompiler() {
        ...
        if (options.getCompilerClassName() != null) {
            ...
            if (options.getCompiler() == null) {
                jspCompiler = createCompiler("tomcat.org.apache.jasper.compiler.JDTCompiler");
                if (jspCompiler == null) {
                    jspCompiler = createCompiler("tomcat.org.apache.jasper.compiler.AntCompiler");
                }
            } else {
                jspCompiler = createCompiler("tomcat.org.apache.jasper.compiler.AntCompiler");
                if (jspCompiler == null) {
