...
public class Set implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        if(hasVar){
            ...
            ctxt.generateJavaSource("                        " + methodName + ".invoke(" + targetName + ", new Object[]{tomcat.org.apache.el.lang.ELSupport.coerceToType(" + jspCtxt + ".getELContext(), " + resultName + ", " + methodName + ".getParameterTypes()[0])});");
            ctxt.generateJavaSource("                    }else{");
