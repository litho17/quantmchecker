...
package tomcat.org.apache.jasper.tagplugins.jstl.core;

import tomcat.org.apache.jasper.compiler.tagplugin.TagPlugin;
import tomcat.org.apache.jasper.compiler.tagplugin.TagPluginContext;
import tomcat.org.apache.jasper.tagplugins.jstl.Util;
...
public class Import implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource(iauName + " = " +
                "tomcat.org.apache.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + urlName + ");");
        ...
        if(hasVarReader){
            ...
            ctxt.generateJavaSource("            " + charSetName + " = " +
                    "tomcat.org.apache.jasper.tagplugins.jstl.Util.getContentTypeAttribute(" + contentTypeName + ", \"charset\");");
            ctxt.generateJavaSource("            if(" + charSetName + " == null) "
                    + charSetName + " = tomcat.org.apache.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }else{");
            ctxt.generateJavaSource("            " + charSetName + " = tomcat.org.apache.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("        }");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        " + tempReaderName + " = new java.io.InputStreamReader(" + inputStreamName + ", tomcat.org.apache.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING);");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("    RequestDispatcher " + requestDispatcherName + " = " + servletContextName + ".getRequestDispatcher(tomcat.org.apache.jasper.tagplugins.jstl.Util.stripSession("+urlName+"));");
            ctxt.generateJavaSource("    if(" + requestDispatcherName + " == null) throw new JspTagException(tomcat.org.apache.jasper.tagplugins.jstl.Util.stripSession("+urlName+"));");

            //initialize a ImportResponseWrapper to include the resource
            ctxt.generateJavaSource("    tomcat.org.apache.jasper.tagplugins.jstl.Util.ImportResponseWrapper " + irwName + " = new tomcat.org.apache.jasper.tagplugins.jstl.Util.ImportResponseWrapper((HttpServletResponse) pageContext.getResponse());");
            ctxt.generateJavaSource("    if(" + charSetName + " == null){");
            ctxt.generateJavaSource("        " + charSetName + " = tomcat.org.apache.jasper.tagplugins.jstl.Util.DEFAULT_ENCODING;");
            ctxt.generateJavaSource("    }");
            ...
            ctxt.generateJavaSource("        throw new JspTagException(" + irwName + ".getStatus()+\" \" + tomcat.org.apache.jasper.tagplugins.jstl.Util.stripSession(" + urlName + "));");
            ctxt.generateJavaSource("    }");
