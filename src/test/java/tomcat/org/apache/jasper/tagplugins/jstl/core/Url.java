...
public class Url implements TagPlugin {
    ...
    public void doTag(TagPluginContext ctxt) {
        ...
        ctxt.generateJavaSource("String " + baseUrlName + " = " +
                "tomcat.org.apache.jasper.tagplugins.jstl.Util.resolveUrl(" + valueName + ", " + contextName + ", pageContext);");
        ...
        ctxt.generateJavaSource("if(!tomcat.org.apache.jasper.tagplugins.jstl.Util.isAbsoluteUrl(" + resultName + ")){");
