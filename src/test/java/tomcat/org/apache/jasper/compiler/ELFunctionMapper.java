...
public class ELFunctionMapper {
    ...
    private class ELFunctionVisitor extends Node.Visitor {
        ...
        private void doMap(ELNode.Nodes el)
            ...
            decName = getMapName();
            ss.append("private static tomcat.org.apache.jasper.runtime.ProtectedFunctionMapper " + decName + ";\n");

            ds.append("  " + decName + "= ");
            ds.append("tomcat.org.apache.jasper.runtime.ProtectedFunctionMapper");
