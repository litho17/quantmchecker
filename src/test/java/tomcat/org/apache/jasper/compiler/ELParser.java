...
import tomcat.org.apache.jasper.compiler.ELNode.ELText;
import tomcat.org.apache.jasper.compiler.ELNode.Function;
import tomcat.org.apache.jasper.compiler.ELNode.Root;
            ...
            if (quote == '\'' || quote == '\"') {
                if (trimmed.charAt(trimmedLen - 1) != quote) {
                    throw new IllegalArgumentException(Localizer.getMessage(
                            "tomcat.org.apache.jasper.compiler.ELParser.invalidQuotesForStringLiteral",
                            input));
                }
        ...
        while (hasNextChar()) {
            ...
            if (ch == '\\') {
                ...
                if (ch == '\\' || ch == '\'' || ch == '\"') {
                    ...
                    throw new IllegalArgumentException(Localizer.getMessage(
                            "tomcat.org.apache.jasper.compiler.ELParser.invalidQuoting",
                            expression));
                }
            } else if (ch == quote) {
                buf.append(ch);
