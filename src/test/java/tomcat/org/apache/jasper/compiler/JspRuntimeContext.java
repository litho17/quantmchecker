 ...
 * &gt;%@Invlude file="..."%&lt; directive is used.
 *
...
public final class JspRuntimeContext {
    ...
    public JspRuntimeContext(ServletContext context, Options options) {
        ...
        if (context instanceof tomcat.org.apache.jasper.servlet.JspCServletContext) {
            codeSource = null;
    ...
    private SecurityHolder initSecurity() {
        ...
        if( policy != null ) {
            try {
                ...
                // Allow the JSP to access tomcat.org.apache.jasper.runtime.HttpJspBase
                permissions.add( new RuntimePermission(
                    "accessClassInPackage.tomcat.org.apache.jasper.runtime") );
