...
import tomcat.org.apache.coyote.AbstractProcessor;
import tomcat.org.apache.coyote.ActionCode;
import tomcat.org.apache.coyote.Adapter;
import tomcat.org.apache.coyote.ErrorState;
import tomcat.org.apache.coyote.Request;
import tomcat.org.apache.coyote.RequestInfo;
import tomcat.org.apache.coyote.UpgradeProtocol;
import tomcat.org.apache.coyote.UpgradeToken;
import tomcat.org.apache.coyote.http11.filters.BufferedInputFilter;
import tomcat.org.apache.coyote.http11.filters.ChunkedInputFilter;
import tomcat.org.apache.coyote.http11.filters.ChunkedOutputFilter;
import tomcat.org.apache.coyote.http11.filters.GzipOutputFilter;
import tomcat.org.apache.coyote.http11.filters.IdentityInputFilter;
import tomcat.org.apache.coyote.http11.filters.IdentityOutputFilter;
import tomcat.org.apache.coyote.http11.filters.SavedRequestInputFilter;
import tomcat.org.apache.coyote.http11.filters.VoidInputFilter;
import tomcat.org.apache.coyote.http11.filters.VoidOutputFilter;
...
import tomcat.org.apache.tomcat.util.buf.Ascii;
...
import tomcat.org.apache.tomcat.util.http.MimeHeaders;
import tomcat.org.apache.tomcat.util.http.parser.HttpParser;
import tomcat.org.apache.tomcat.util.log.UserDataHelper;
...
import tomcat.org.apache.tomcat.util.net.SendfileDataBase;
import tomcat.org.apache.tomcat.util.net.SendfileKeepAliveState;
import tomcat.org.apache.tomcat.util.net.SendfileState;
...
public class Http11Processor extends AbstractProcessor {
    ...
    public SocketState service(SocketWrapperBase<?> socketWrapper)
        ...
        rp.setStage(tomcat.org.apache.coyote.Constants.STAGE_PARSE);
        ...
        while (!getErrorState().isError() && keepAlive && !isAsync() && upgradeToken == null &&
            ...
            if (getErrorState().isIoAllowed()) {
                ...
                rp.setStage(tomcat.org.apache.coyote.Constants.STAGE_PREPARE);
                try {
                    prepareRequest();
                } catch (Throwable t) {
                    ExceptionUtils.handleThrowable(t);
            ...
            if (getErrorState().isIoAllowed()) {
                try {
                    rp.setStage(tomcat.org.apache.coyote.Constants.STAGE_SERVICE);
            ...
            rp.setStage(tomcat.org.apache.coyote.Constants.STAGE_ENDINPUT);
            if (!isAsync()) {
            ...
            rp.setStage(tomcat.org.apache.coyote.Constants.STAGE_ENDOUTPUT);
            ...
            rp.setStage(tomcat.org.apache.coyote.Constants.STAGE_KEEPALIVE);

            sendfileState = processSendfile(socketWrapper);
        }

        rp.setStage(tomcat.org.apache.coyote.Constants.STAGE_ENDED);
    ...
    private void prepareSendfile(OutputFilter[] outputFilters) {
        String fileName = (String) request.getAttribute(
                tomcat.org.apache.coyote.Constants.SENDFILE_FILENAME_ATTR);
        if (fileName == null) {
            sendfileData = null;
        } else {
            ...
            long pos = ((Long) request.getAttribute(
                    tomcat.org.apache.coyote.Constants.SENDFILE_FILE_START_ATTR)).longValue();
            long end = ((Long) request.getAttribute(
                    tomcat.org.apache.coyote.Constants.SENDFILE_FILE_END_ATTR)).longValue();
