...
import tomcat.org.apache.coyote.CloseNowException;
...
import tomcat.org.apache.coyote.http11.HttpOutputBuffer;
import tomcat.org.apache.coyote.http11.OutputFilter;
import tomcat.org.apache.coyote.http2.HpackDecoder.HeaderEmitter;
...
import tomcat.org.apache.tomcat.util.http.parser.Host;
...
class Stream extends AbstractStream implements HeaderEmitter {
    ...
    private static void push(final Http2UpgradeHandler handler, final Request request,
        ...
        if (tomcat.org.apache.coyote.Constants.IS_SECURITY_ENABLED) {
            try {
