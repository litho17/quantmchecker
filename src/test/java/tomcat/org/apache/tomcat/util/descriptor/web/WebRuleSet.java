 ...
 */
package tomcat.org.apache.tomcat.util.descriptor.web;

import java.lang.reflect.Method;
import java.util.ArrayList;

import tomcat.org.apache.tomcat.util.IntrospectionUtils;
import tomcat.org.apache.tomcat.util.digester.CallMethodRule;
import tomcat.org.apache.tomcat.util.digester.CallParamRule;
import tomcat.org.apache.tomcat.util.digester.Digester;
import tomcat.org.apache.tomcat.util.digester.Rule;
import tomcat.org.apache.tomcat.util.digester.RuleSet;
import tomcat.org.apache.tomcat.util.digester.SetNextRule;
...
public class WebRuleSet implements RuleSet {
    ...
    public void addRuleInstances(Digester digester) {
        ...
        digester.addObjectCreate(fullPrefix + "/error-page",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.ErrorPage");
        ...
        digester.addObjectCreate(fullPrefix + "/filter",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.FilterDef");
        ...
        digester.addObjectCreate(fullPrefix + "/filter-mapping",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.FilterMap");
        ...
        digester.addObjectCreate(fullPrefix + "/jsp-config/jsp-property-group",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.JspPropertyGroup");
        ...
        digester.addObjectCreate(fullPrefix + "/login-config",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.LoginConfig");
        ...
        digester.addObjectCreate(fullPrefix + "/security-constraint",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.SecurityConstraint");
        ...
        digester.addObjectCreate(fullPrefix + "/security-constraint/web-resource-collection",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.SecurityCollection");
        ...
        digester.addSetNext(fullPrefix + "/servlet",
                            "addServlet",
                            "tomcat.org.apache.tomcat.util.descriptor.web.ServletDef");
        ...
        digester.addObjectCreate(fullPrefix + "/servlet/security-role-ref",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.SecurityRoleRef");
        ...
        digester.addObjectCreate(fullPrefix + "/servlet/multipart-config",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.MultipartDef");
        ...
        digester.addObjectCreate(fullPrefix + "/session-config",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.SessionConfig");
    ...
    protected void configureNamingRules(Digester digester) {
        ...
        digester.addObjectCreate(fullPrefix + "/ejb-local-ref",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.ContextLocalEjb");
        ...
        digester.addObjectCreate(fullPrefix + "/ejb-ref",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.ContextEjb");
        ...
        digester.addObjectCreate(fullPrefix + "/env-entry",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.ContextEnvironment");
        ...
        digester.addObjectCreate(fullPrefix + "/resource-env-ref",
            "tomcat.org.apache.tomcat.util.descriptor.web.ContextResourceEnvRef");
        ...
        digester.addObjectCreate(fullPrefix + "/message-destination",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.MessageDestination");
        ...
        digester.addObjectCreate(fullPrefix + "/message-destination-ref",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.MessageDestinationRef");
        ...
        digester.addObjectCreate(fullPrefix + "/resource-ref",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.ContextResource");
        ...
        digester.addObjectCreate(fullPrefix + "/service-ref",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.ContextService");
        ...
        digester.addObjectCreate(fullPrefix + "/service-ref/handler",
                                 "tomcat.org.apache.tomcat.util.descriptor.web.ContextHandler");
 ...
 * <code>tomcat.org.apache.tomcat.util.descriptor.web.SecurityConstraint</code>.
 */
