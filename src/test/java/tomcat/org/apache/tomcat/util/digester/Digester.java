 ...
 */
package tomcat.org.apache.tomcat.util.digester;
...
public class Digester extends DefaultHandler2 {
    ...
    static {
        String className = System.getProperty("tomcat.org.apache.tomcat.util.digester.PROPERTY_SOURCE");
        ...
        if (className != null) {
            ...
            for (int i = 0; i < cls.length; i++) {
                try {
                    ...
                    LogFactory.getLog("tomcat.org.apache.tomcat.util.digester.Digester")
        ...
        if (Boolean.getBoolean("tomcat.org.apache.tomcat.util.digester.REPLACE_SYSTEM_PROPERTIES")) {
     ...
     */
    protected Log saxLog = LogFactory.getLog("tomcat.org.apache.tomcat.util.digester.Digester.sax");
    ...
    protected void configure() {
        ...
        log = LogFactory.getLog("tomcat.org.apache.tomcat.util.digester.Digester");
        saxLog = LogFactory.getLog("tomcat.org.apache.tomcat.util.digester.Digester.sax");
