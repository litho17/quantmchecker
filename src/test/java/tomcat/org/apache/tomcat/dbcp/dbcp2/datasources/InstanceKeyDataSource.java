...
package tomcat.org.apache.tomcat.dbcp.dbcp2.datasources;
...
import tomcat.org.apache.tomcat.dbcp.pool2.impl.BaseObjectPoolConfig;
import tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericKeyedObjectPoolConfig;
 ...
 * {@link tomcat.org.apache.tomcat.dbcp.dbcp2.cpdsadapter.DriverAdapterCPDS},
...
public abstract class InstanceKeyDataSource
    ...
    */
    ...
    /**
     * @return the default value for
     * {@link tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericObjectPool GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each
     * per user pool.
     */
    ...
    /**
     * Sets the default value for
     * {@link tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericObjectPool GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each per user pool.
    ...
    /**
     * @return the default value for
     * {@link tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnCreate()} for each per user pool.
     */
    ...
    /**
     * @return the default value for
     * {@link tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnBorrow()} for each per user pool.
     */
    ...
    /**
     * @return the default value for
     * {@link tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnReturn()} for each per user pool.
     */
    ...
    /**
     * @return the default value for
     * {@link tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericObjectPool GenericObjectPool#getTestWhileIdle()} for each per user pool.
     */
    ...
    /**
     * @return the default value for
     * {@link tomcat.org.apache.tomcat.dbcp.pool2.impl.GenericObjectPool GenericObjectPool#getTimeBetweenEvictionRunsMillis ()} for each
     * per user pool.
     */
