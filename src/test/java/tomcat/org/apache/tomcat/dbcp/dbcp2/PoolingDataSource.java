...
public class PoolingDataSource<C extends Connection> implements DataSource, AutoCloseable {
    ...
    private class PoolGuardConnectionWrapper<D extends Connection>
        ...
        /**
         * @see tomcat.org.apache.tomcat.dbcp.dbcp2.DelegatingConnection#getDelegate()
         */
        @Override
        ...
        /**
         * @see tomcat.org.apache.tomcat.dbcp.dbcp2.DelegatingConnection#getInnermostDelegate()
         */
        @Override
