 ...
 */
package tomcat.org.apache.tomcat.websocket;
...
public class Constants {
    ...
    static final int DEFAULT_BUFFER_SIZE = Integer.getInteger(
            "tomcat.org.apache.tomcat.websocket.DEFAULT_BUFFER_SIZE", 8 * 1024)
            .intValue();
    ...
    public static final String SSL_PROTOCOLS_PROPERTY =
            "tomcat.org.apache.tomcat.websocket.SSL_PROTOCOLS";
    public static final String SSL_TRUSTSTORE_PROPERTY =
            "tomcat.org.apache.tomcat.websocket.SSL_TRUSTSTORE";
    public static final String SSL_TRUSTSTORE_PWD_PROPERTY =
            "tomcat.org.apache.tomcat.websocket.SSL_TRUSTSTORE_PWD";
    ...
    public static final String IO_TIMEOUT_MS_PROPERTY =
            "tomcat.org.apache.tomcat.websocket.IO_TIMEOUT_MS";
    ...
    public static final String MAX_REDIRECTIONS_PROPERTY =
            "tomcat.org.apache.tomcat.websocket.MAX_REDIRECTIONS";
    ...
    static final String DEFAULT_ORIGIN_HEADER_VALUE =
            System.getProperty("tomcat.org.apache.tomcat.websocket.DEFAULT_ORIGIN_HEADER_VALUE");

    // Configuration for blocking sends
    public static final String BLOCKING_SEND_TIMEOUT_PROPERTY =
            "tomcat.org.apache.tomcat.websocket.BLOCKING_SEND_TIMEOUT";
    ...
    static final int DEFAULT_PROCESS_PERIOD = Integer.getInteger(
            "tomcat.org.apache.tomcat.websocket.DEFAULT_PROCESS_PERIOD", 10)
            .intValue();

    public static final String WS_AUTHENTICATION_USER_NAME = "tomcat.org.apache.tomcat.websocket.WS_AUTHENTICATION_USER_NAME";
    public static final String WS_AUTHENTICATION_PASSWORD = "tomcat.org.apache.tomcat.websocket.WS_AUTHENTICATION_PASSWORD";
    ...
    static final boolean DISABLE_BUILTIN_EXTENSIONS =
            Boolean.getBoolean("tomcat.org.apache.tomcat.websocket.DISABLE_BUILTIN_EXTENSIONS");
    static final boolean ALLOW_UNSUPPORTED_EXTENSIONS =
            Boolean.getBoolean("tomcat.org.apache.tomcat.websocket.ALLOW_UNSUPPORTED_EXTENSIONS");

    // Configuration for stream behavior
    static final boolean STREAMS_DROP_EMPTY_MESSAGES =
            Boolean.getBoolean("tomcat.org.apache.tomcat.websocket.STREAMS_DROP_EMPTY_MESSAGES");

    public static final boolean STRICT_SPEC_COMPLIANCE =
            Boolean.getBoolean("tomcat.org.apache.tomcat.websocket.STRICT_SPEC_COMPLIANCE");
