...
import tomcat.javax.websocket.server.ServerContainer;
import tomcat.javax.websocket.server.ServerEndpoint;
import tomcat.javax.websocket.server.ServerEndpointConfig;
import tomcat.javax.websocket.server.ServerEndpointConfig.Configurator;
...
import tomcat.org.apache.tomcat.websocket.WsWebSocketContainer;
import tomcat.org.apache.tomcat.websocket.pojo.PojoMethodMapping;
...
public class WsServerContainer extends WsWebSocketContainer
    ...
    private volatile boolean enforceNoAddAfterHandshake =
            tomcat.org.apache.tomcat.websocket.Constants.STRICT_SPEC_COMPLIANCE;
    ...
    public void addEndpoint(ServerEndpointConfig sec)
        ...
        if (methodMapping.getOnClose() != null || methodMapping.getOnOpen() != null
            ...
            sec.getUserProperties().put(tomcat.org.apache.tomcat.websocket.pojo.Constants.POJO_METHOD_MAPPING_KEY,
                    methodMapping);
        }
