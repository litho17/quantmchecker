...
import tomcat.org.apache.tomcat.websocket.BackgroundProcess;
import tomcat.org.apache.tomcat.websocket.BackgroundProcessManager;
 ...
 * only have access to {@link ServletOutputStream} and
 * {@link ServletInputStream} so there is no way to set a timeout
