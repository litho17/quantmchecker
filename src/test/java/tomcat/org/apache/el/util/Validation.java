...
public class Validation {
    ...
    static {
        ...
        if (IS_SECURITY_ENABLED) {
                    ...
                    new PrivilegedAction<String>(){
                        ...
                        public String run() {
                            return System.getProperty(
                                    "tomcat.org.apache.el.parser.SKIP_IDENTIFIER_CHECK",
                                    "false");
                        }
                    }
            );
            ...
            skipIdentifierCheckStr = System.getProperty(
                    "tomcat.org.apache.el.parser.SKIP_IDENTIFIER_CHECK", "false");
        }
     ...
     * {@code tomcat.org.apache.el.parser.SKIP_IDENTIFIER_CHECK}
     *
