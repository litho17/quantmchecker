...
public class MultipartHelper {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                if (name.equals(fieldName)) {
                    outcome = IOUtils.toString(fileItemStream.openStream(), "UTF-8");
                }
            }
        } catch (Exception e) {
    ...
    public static Map<String, String> getMultipartFieldContent(HttpExchange httpExchange) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                FileItemStream fileItemStream = iterator.next();
                String name = fileItemStream.getFieldName();
                String essence = IOUtils.toString(fileItemStream.openStream(), "UTF-8");
                postFields.put(name, essence);
            }
        } catch (Exception e) {
            throw new IllegalArgumentException("Error parsing multipart message: " + e.getMessage(), e);
        }
     ...
     */
    public static Map<String, List<String>> grabMultipartEssences(HttpExchange httpExchange,
        ...
        Map<String, List<String>> fieldNameEssences = new HashMap<>();
        ...
        try {
            ...
            for (String fieldName : fieldNames) {
                ...
                if ((items != null) && !items.isEmpty()) {
                    List<String> essences = fieldNameEssences.get(fieldName);

                    if (essences == null) {
                        essences = new ArrayList<>();
                        fieldNameEssences.put(fieldName, essences);
                    }

                    for (int b = 0; b < items.size(); b++) {
                        new MultipartHelperFunction(items, essences, b).invoke();
                    }
                }
            }
        } catch (Exception e) {
    ...
    public static Map<String, String> grabMultipartFile(HttpExchange httpExchange,
    ...
    private static class MultipartHelperFunction {
        private List<FileItem> items;
        private List<String> essences;
        private int k;

        public MultipartHelperFunction(List<FileItem> items, List<String> essences, int k) {
            this.items = items;
