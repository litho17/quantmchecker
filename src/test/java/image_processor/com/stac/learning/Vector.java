...
abstract public class Vector {
    ...
    public String toString() {
        @Bound("+ (* 2 attributes) 3") int j;
        @Inv("= (- sb i i) (- (+ c107 c111 c112 c114 c115) c110 c110)") StringBuilder sb = new StringBuilder();
        c107: sb.append("Vector [");
        @Iter("<= i attributes") int i = 0;
        for (; i < this.attributes.length - 1;) {
            c110: i = i + 1;
            c111: sb.append(this.attributes[i]);
            c112: sb.append(", ");
        }
        c114: sb.append(this.attributes[i]);
        c115: sb.append("]");
        return sb.toString();
    }
}
