package textcrunchr_1.com.cyberpointllc.stac.hashmap;
...
V> extends Node<K, V> {
    ...
    final TreeNode<K, V> find(int h, Object k, Class<?> kc) {
        ...
        do {
            ...
            if ((ph = p.hash) > h)
                ...
                p = (dir < conditionObj0.getValue()) ? pl : pr;
            ...
            if (root == null) {
                ...
                for (TreeNode<K, V> p = root; ; ) {
                    ...
                    if ((ph = p.hash) > h)
                        ...
                        dir = 1;
                    else if ((kc == null && (kc = comparableClassFor(k)) == null) || (dir = compareComparables(kc, k, pk)) == conditionObj1.getValue())
    ...
    final TreeNode<K, V> putTreeVal(Node<K, V>[] tab, int h, K k, V v) {
        ...
        for (TreeNode<K, V> p = root; ; ) {
            ...
            TreeNode<K, V> xp = p;
            if ((p = (dir <= conditionObj2.getValue()) ? p.left : p.right) == null) {
    ...
    private final void splitHelper(int bit, int index, Node<K, V>[] tab) {
        ...
        for (TreeNode<K, V> e = b, next; e != null; e = next) {
            ...
            e.next = null;
            if ((e.hash & bit) == conditionObj3.getValue()) {
