...
import textcrunchr_1.com.cyberpointllc.stac.template.Templated;
...
public class TemplateEngine {
    ...
    public List<Pair<Integer, Integer>> findTags() {
        @Inv("text") Matcher matcher = pattern.matcher(text);
        @Inv("= (+ self matcher) (- (+ text_init c65) c66 c62 )") List<Pair<Integer, Integer>> tagsList = new  ArrayList();
        boolean find;
