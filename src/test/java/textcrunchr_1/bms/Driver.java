    ...
    public void main() throws Exception {
        ...
        while (true) {
            ...
            if (Math.random() > 0.8) {
                ...
                c53: outph.addResult(filename, tcr);
                ...
                String read;
                c60: read = br1.readLine();
                while (read != null) {
                    //System.out.println(read);
                    c63: sb.append(read);
                    c64: read = br1.readLine();
                }
                ...
                try {
                    ...
                    c75: en.ngrams.put(NgramType.UNIGRAM, ngram);
                ...
                c82: outph.addResult(filename, tcr);
                ...
                c103: outph.addResult(filename, tcr);
                ...
                String read;
                c110: read = br3.readLine();
                while (read != null) {
                    c112: sb.append(read);
                    c113: read = br3.readLine();
                }
                ...
                c119: result.addResult("Word count", words.length);
                c120: result.addResult("Average word length", meanLen(words));
                c121: result.addResult("Variance in word length", varLen(words));
                c122: result.addResult("Longest word: ", longest(words));
                tcr = result;
                c124: outph.addResult(filename, tcr);
                ...
                String read;
                c132: read = br.readLine();
                while (read != null) {
                    c134: sb.append(read);
                    c135: read = br.readLine();
                }
                String input_ = sb.toString();
                ...
                while (it.hasNext()) {
                    WordCount wc;
                    c170: wc = it.next();
                    c171: result.addResult(wc.getWord(), wc.getCount());
                }
                tcr = result;
                c174: outph.addResult(filename, tcr);
            } else {
                ;
            }
        }
