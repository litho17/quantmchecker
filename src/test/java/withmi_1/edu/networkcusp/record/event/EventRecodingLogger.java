...
public class EventRecodingLogger implements Logger {
    ...
    private void recordEvent(Level level, Marker marker, String msg, Object[] args, Throwable throwable) {
        ...
        loggingEvent.defineTimeStamp(System.currentTimeMillis());
        loggingEvent.assignLevel(level);
        loggingEvent.assignLogger(logger);
        loggingEvent.assignLoggerName(name);

        loggingEvent.defineMessage(msg);
