...
public class MessageUtils {
     ...
     */
    public static Chat.WithMiMsg.Builder createDiscussionMsgBuilder(String line) {
    ...
    public static Chat.WithMiMsg.Builder createReceipt(boolean handleSuccess, float messageId) {
        // send receipt
